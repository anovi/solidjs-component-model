...
export type EventName<E> =
    E extends { type: infer T extends PropertyKey }
        ? T
        : never;
...
export type Guard<TModel, E extends Event> =
    (this: TModel, ev: E) => boolean;

export type AnyAction = Action<unknown, Event>;

export type Action<TModel, E extends Event> =
    (this: TModel, ev: E) => void;
