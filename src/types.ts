...
export type Eventless  = { type: typeof InternalEventName.Eventless, state: string }
export type InvokedDone<T = unknown> = { type: typeof InternalEventName.InvokedDone, result: T, state: string }
export type InvokedError = { type: typeof InternalEventName.InvokedError, error: unknown, state: string }
export type InvokedNext<V = unknown> = { type: typeof InternalEventName.InvokedNext, value: V, state: string }
export type ScheduledExecute  = { type: typeof InternalEventName.ScheduledExecute, state: string }
