...
export function WithStateChart<
  ...
  >
    ? EE
    : Event,
  TConfig extends StateChartConfig<InstanceType<TBase>, E> = StateChartConfig<
    InstanceType<TBase>,
    E
  >,
>(
...
>(
  ...
  const stateChart =
    configOrChart instanceof StateChart
      ? configOrChart
  ...
  return WithStateChartC as unknown as WithStateChartConstructor<
    TBase,
    TConfig
  >;
}
