...
type Events =
  { type: "SOME"; value: string } | { type: "OTHER"; value: string };
...
class ModelWithChildStateNodesBase extends ComponentModel<Data, Events, Emits> {
  ...
  other(value: string) {
    this.dispatch({ type: "OTHER", value });
  }
...
export const ModelWithChildStateNodes = WithStateChart(
  ModelWithChildStateNodesBase,
  {
    govno: "alskjdf",
    initial: "default",
    invoke: {
