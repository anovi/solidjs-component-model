 ...
 */
export declare function generateTransitionSteps(diff: TransitionDiff): Generator<TransitionStep<ExecutionContext, Event>, void>;
export declare class StatePath {
    ...
    toString(): string;
    toArray(): string[];
    static fromArray(array: string[]): StatePath;
