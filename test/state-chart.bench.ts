...
describe('Interpreter.transition', () => {
    ...
    bench('baseline', () => {
        ...
        for (const _ of baselineRuntime.transition('with_always', 'from_always')) {
            void _;
        }
        for (const _ of baselineRuntime.transition('from_always', 'with_children')) {
            void _;
        }
        for (const _ of baselineRuntime.transition('with_children.child1', 'default', true)) {
            void _;
        }
    }, {
        iterations: 10000,
    ...
    bench('new', () => {
        ...
        for (const _ of newRuntime.transition('with_children.child1', 'default', true)) {
            void _;
        }
    }, {
        iterations: 10000,
...
describe('Interpreter.getMostSpecificHandler', () => {
    ...
    bench('baseline', () => {
        ...
        baselineRuntime.getMostSpecificHandler('with_children.child1', { type: 'SOME' });
    }, {
        iterations: 50000,
        throws: true,
    });
    ...
    bench('new', () => {
        ...
        newRuntime.getMostSpecificHandler('with_children.child1', { type: 'SOME' });
    }, {
        iterations: 50000,
        throws: true,
    });
